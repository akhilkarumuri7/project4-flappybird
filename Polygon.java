...
//    for (Point p : shape) {
	...
	public boolean collides(Polygon other) {
		// Check if any point of 'this' polygon is contained in 'other'
		for (Point p : this.getPoints()) {
			if (other.contains(p))
				return true;
		}
		// Check if any point of 'other' polygon is contained in 'this'
	...
	/*
	 * The following methods are private access restricted because, as this access level
	 * always implies, they are intended for use only as helpers of the methods in this
	 * class that are not private. They can't be used anywhere else.
	 */
